...
(mymodel3 <- runMLwiN(logit(use,denomb)~1+age+lc, D="Binomial", estoptions=list(EstM=1), data=bang1))
...
(mymodel5 <- runMLwiN(logit(use,denomb)~1+age+lc+urban+(district|1), D="Binomial", estoptions=list(EstM=1), data=bang1))

(mymodel6 <- runMLwiN(logit(use,denomb)~1+age+lc+urban+(district|1+urban), D="Binomial", estoptions=list(EstM=1), data=bang1))
