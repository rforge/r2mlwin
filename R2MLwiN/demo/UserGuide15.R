...
(mymodel1 <- runMLwiN(n_ilea ~ 1 + n_vrq + (school | 1 + n_vrq) + (pupil | 1), estoptions = list(resi.store = TRUE, 
...
(mymodel2 <- runMLwiN(n_ilea ~ 1 + n_vrq + s17p22 + (school | 1 + n_vrq) + (pupil | 1), estoptions = list(resi.store = TRUE, 
...
(mymodel3 <- runMLwiN(n_ilea ~ 1 + n_vrq + s17p22 + s17 + s17Xn_vrq + (school | 1 + n_vrq) + (pupil | 1), estoptions = list(startval = list(FP.b = mymodel2@FP, 
  FP.v = mymodel2@FP.cov, RP.b = mymodel2@RP, RP.v = mymodel2@RP.cov)), data = diag1))

(mymodel4 <- runMLwiN(n_ilea ~ 1 + n_vrq + s17p22 + s17 + (school | 1 + n_vrq) + (pupil | 1), estoptions = list(resi.store = TRUE, 
